...
릴리스 안내: v0.92.0은 Hook 초기 로딩과 반복 바인딩 비용을 줄이고 검증·대시보드 모듈을 분리합니다. Linux·macOS·Windows CI는 전체 테스트를 분할 실행하며, 자동 샤딩과 권위 있는 근거 재사용을 유지합니다.
