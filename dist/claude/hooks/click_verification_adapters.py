...
_DESCRIPTORS = (
    ...
    _descriptor("node-test-v1", "node-test", runtime_observation="profile-limited"),
    _descriptor("node-check-v1", "node-check"),
    _descriptor("javascript-package-script-v1", "package-script", runtime_observation="profile-limited"),
    _descriptor(
        VITEST_ADAPTER,
        "vitest",
